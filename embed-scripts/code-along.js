...
async function codeAlong(config) {
  ...
  const codeAlongCode = await new Promise((resolve, reject) => {
    ...
    tempIframe.id = 'temp';
    tempIframe.style = 'height:100vh;width:100%;overflow:hidden;';
  ...
  htmlEditorDiv.style = 'height:35vh;width:60vw;';
  ...
  cssEditorDiv.style = 'height:35vh;width:60vw;';
  ...
  outputContainer.style = 'height: 69vh; width: 40vw; border:solid; padding-left:3%; padding-right:3%;';
